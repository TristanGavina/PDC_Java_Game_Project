 ...
 * @author trist
 */
public class GuideAndDetails implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final String GAMEHELP_PATH = "GameUIs/gameHelp.txt";
    private static final String HELP_PATH = "GameUIs/help.txt";
